...
>
> **⚠️ "BUILT" IS NOT "PROVEN", AND §10 IS WHERE THE DIFFERENCE LIVES.** Of the seven criteria this
> pass touched, **two are cleanly satisfied (A-67, A-67c)**, four are **partial** with the missing half
> named on each (A-55, A-56, A-58, A-67b), and **A-57 is NOT SATISFIED** — completing and verifying
> now exist, so the M-3 badge criterion became testable in S117 and was simply not written. It is the
> gap most likely to be mistaken for covered, because everything around it went green in the same pass.
>
