...
// no rate is ever future-dated; the first rate per instrument+rate_type may
// be backdated to the signing date, later rates land between the latest
// existing rate and today — DB trigger instrument_rates_backdating_guard,
