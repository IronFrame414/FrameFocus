...
// §3i — the auth gate and the real clock. The LOOP lives in
// lib/notify/crons/daily-log-missing.ts.
//
...
export async function GET(request: NextRequest) {
  ...
  const outcome = await runDailyLogMissing(getSupabaseAdmin() as SupabaseClient<Database>, new Date());
