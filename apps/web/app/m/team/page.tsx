...
function chips(t: T): readonly Chip[] {
  return [
    ...
    { value: 'crew', label: t('directory.team.chip.crew'), testKey: 'Crew' },
    { value: 'subcontractor', label: t('directory.team.chip.subs'), testKey: 'Subs' },
  ];
}
...
export default async function MobileTeamPage({
  ...
  const emptyCopy =
    active === 'crew'
      ? t('directory.team.emptyCrew')
      : active === 'subcontractor'
        ? t('directory.team.emptySubs')
        : t('directory.team.empty');

  return (
    <div className="px-[18px] pb-[18px] pt-[14px]">
      <SetMobileHeader title={t('directory.team.title')} sub={t('directory.team.companyRoster')} />

      <FilterChips chips={chips(t)} active={active} basePath="/m/team" param="type" t={t} />
