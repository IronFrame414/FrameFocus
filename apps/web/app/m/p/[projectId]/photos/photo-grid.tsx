...
const BADGE: Record<NonNullable<GridPhoto['source']>, { labelKey: MsgKey; fill: string }> = {
  log: { labelKey: 'photos.badge.log', fill: 'rgba(20,33,61,.72)' },
  delivery: { labelKey: 'photos.badge.delivery', fill: 'rgba(20,33,61,.72)' },
  punch: { labelKey: 'photos.badge.punch', fill: 'rgba(180,83,9,.85)' },
  safety: { labelKey: 'photos.badge.safety', fill: 'rgba(192,54,44,.85)' },
};
    ...
    <>
      ...
      {photo.hasMarkup ? (
        <span
          ...
          aria-label={t('photos.grid.hasMarkup')}
      ...
      {confirming ? (
        ...
        >
          ...
          <div className="mt-[10px] flex gap-[8px]">
            ...
            >
              {busy ? t('photos.grid.deleting') : t('photos.grid.delete')}
            </button>
            <button
              type="button"
