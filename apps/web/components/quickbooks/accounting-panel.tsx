...
// ⚠️ `PaymentAccountCard` WAS HERE AND IS GONE [M-J, superseding M-G]. It held
// ONE company-wide default in `companies.qb_payment_account_*`, and those three
// columns are dropped. Josh superseded it: a contractor has business checking,
// one or more cards, maybe petty cash, and a Purchase must say which one paid
// or the books are wrong. The replacement is a LIST plus a per-user default,
// in `components/quickbooks/account-settings.tsx`, mounted beside this panel.
